import type { ReasonTone } from '../types';
...
export const LOG_ROWS: LogRow[] = [
  ...
  },
  {
    ...
    eap: 'PEAP-MSCHAPv2', reply: 'Access-Reject', reason: '账号锁定', rtagTone: 'warn',
  ...
  },
  {
    ...
    eap: 'EAP-TLS', reply: 'Access-Reject', reason: 'MAC 未绑定', rtagTone: 'danger',
  ...
  },
  {
    ...
    eap: 'EAP-TLS', reply: 'Access-Reject', reason: '证书过期', rtagTone: 'danger',
  ...
  },
  {
    ...
    eap: 'PEAP-MSCHAPv2', reply: 'Access-Reject', reason: '时间策略拒绝', rtagTone: 'muted',
  ...
  },
  {
    ...
    eap: 'PEAP-MSCHAPv2', reply: 'Access-Reject', reason: '密码错误', rtagTone: 'warn',
  ...
  },
  {
    ...
    eap: 'EAP-TLS', reply: 'Access-Reject', reason: '终端不合规', rtagTone: 'warn',
