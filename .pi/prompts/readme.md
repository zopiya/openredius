...
1. Inspect the current repository structure and existing instructions (`AGENTS.md`, `.pi/skills/`, `docs/`).
2. Describe what the project is, how to use it, and the important commands — practical, not aspirational.
