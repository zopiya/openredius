 ...
 * says "Ask clarifying questions using the questionnaire tool" — that only
 * works if this tool is actually registered. Without it, "questionnaire" is
 * silently dropped from the active tool set (unknown tool names are ignored,
 * not errored) and plan mode's own instructions point at nothing.
 */
